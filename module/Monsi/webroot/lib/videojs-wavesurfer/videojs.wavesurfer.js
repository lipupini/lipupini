...
var _default = exports["default"] = WavesurferMiddleware;
module.exports = exports.default;
...
var Wavesurfer = exports.Wavesurfer = function (_Plugin) {
  function Wavesurfer(player, options) {
    var _this;
    _classCallCheck(this, Wavesurfer);
    _this = _callSuper(this, Wavesurfer, [player, options]);
    player.addClass(wavesurferStyleName);
    if (_video.default.obj !== undefined) {
      options = _video.default.obj.merge(_defaults.default, options);
    } else {
    ...
    _this.player.one(_event.default.READY, _this.initialize.bind(_this));
    return _this;
  }
  _inherits(Wavesurfer, _Plugin);
  return _createClass(Wavesurfer, [{
    key: "initialize",
