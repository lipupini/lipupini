...
class State {
	...
	public function __construct(
		...
		public string $dirSrc             = '/dev/null', // Source directory, set in `__construct`
		...
		public array  $request            = [], // Request queue for `Lipupini\Request\Incoming\Queue`
		...
		if ($this->dirSrc === '/dev/null') {
			$this->dirSrc = $this->dirRoot . '/src';
		}

		if ($this->dirWebroot === '/dev/null') {
			$this->dirWebroot = $this->dirRoot . '/webroot';
		}
